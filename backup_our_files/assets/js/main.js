...
console.log('🚀 Jekyll Website loaded successfully!');
console.log('📱 Mobile menu: Click the hamburger icon');
console.log('🎯 Smooth scrolling: Click navigation links');
console.log('✨ Animations: Scroll to see elements fade in');
console.log('🔧 Jekyll: Static site generation with dynamic content');
